...
function carga_todos() {
    var url = "http://localhost/Service/Service.asmx/GetPerfilUsu";
    $.getJSON(url, {
        format: "json"
    })
        .done(function (data) {
    ...
    var url2 = "http://localhost/Service/Service.asmx/GetAllPerfiles";
    $.getJSON(url2, {
        format: "json"
    })
        .done(function (data2) {
    ...
    var url3 = "http://localhost/Service/Service.asmx/GetAllUsers";
    $.getJSON(url3, {
        format: "json"
    })
        .done(function (data3) {
