                ...
                <div class="card">
                    ...
                    <div class="card-body card-block">
                        ...
                        <div class="modal-footer">                                                  
                            <asp:Button ID="btn_activar" runat="server" Text="Activar"  class="btn" BackColor="#4272d7" ForeColor="White" OnClick="btn_activar_Click" />
        ...
        <!-- END BREADCRUMB-->                  
            <div class="col-lg-12">
                <div class="card">                 
                    <div class="card-body card-block">
                        <div class="col-lg-10">
                            <asp:GridView ID="dgvDatos" runat="server" CellPadding="4" ForeColor="#ffffff" GridLines="None" OnRowDataBound="dgv_usuario_RowDataBound" OnSelectedIndexChanged="Seleccionar_registro" Width="950px">
