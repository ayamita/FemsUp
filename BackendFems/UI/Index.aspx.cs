...
namespace BackendFems.UI
{
    public partial class Index : System.Web.UI.Page
    {
        ...
        {
            string sUrlRequest = "https://localhost:44317/Service.asmx/GetPublicCategory";
        ...
        {
            string sUrlRequest = "https://localhost:44317/Service.asmx/GetAllPublic";
            var json = new WebClient().DownloadString(sUrlRequest);            
            return json;
        }
        protected string AllPublicbyfecha(string inicio, string final)
        {
            string sUrlRequest = "https://localhost:44317/Service.asmx/GetAllPublicByDate?inicio=" + inicio + "&final=" + final; 
            var json = new WebClient().DownloadString(sUrlRequest);
            return json;
        }
        protected string PublicRequest()
        {       
            string sUrlRequest = "https://localhost:44317/Service.asmx/GetPublicRequested";
            var json = new WebClient().DownloadString(sUrlRequest);            
            return json;
        }
        protected string PublicRequestbyFecha(string inicio, string final)
        {
            string sUrlRequest = "https://localhost:44317/Service.asmx/GetPublicRequestedByDate?inicio=" + inicio + "&final=" + final;
            var json = new WebClient().DownloadString(sUrlRequest);
            return json;
        }
